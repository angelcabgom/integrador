...
## Para importar la base de datos primero se debe crear una base de datos con phpMyAdmin y sobre esa base de datos 
## importar la base de datos subida al repositorio.

La ultima copia de la base de datos subida a gitHub es del 21/01/2024.
